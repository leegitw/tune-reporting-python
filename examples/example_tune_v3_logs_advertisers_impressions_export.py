...
def main(tmc_api_key):
    ...
    tune_v3_logs_advertisers_impressions_export.logger_level = logging.DEBUG
    ...
    try:
        tune_v3_logs_advertisers_impressions_export.collect(
    ...
    for row in list(tune_v3_logs_advertisers_impressions_export.generator):
        pprint(row)
